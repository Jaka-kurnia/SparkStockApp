...
<div class="container-xl">
    <div class="row row-cards">
        <div class="col-12">
            <form action="{{ route('service.store') }}" method="POST" class="card">
                @csrf
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('is_service') is-invalid @enderror" name="is_service">
                                    <option value="1" {{ old('is_service', '1') == '1' ? 'selected' : '' }}>Aktif</option>
                ...
                <div class="card-footer text-end">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('service.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </div>
